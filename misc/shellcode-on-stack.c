 ...
 * make linux run code that is located on the
 * stack.
 *
 * Cause it is possible to run shellcode
 * that is located in data section. Which, as I
 * thought, should be impossible. */
...
void foo(int arg) {
	unsigned char shellcode[] = {
		...
		0xbb, 0x20, 0x00, 0x00, 0x00, /* mov ebx, 32 */
		0xcd, 0x80,                   /* int 0x80 */
